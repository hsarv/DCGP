...
class MostSynergisticFeatures:
    ...
    def createModel(self):
        ...
        models = {
            ...
            "RFreg": RandomForestRegressor(n_estimators=50, random_state=0, oob_score=True),
    ...
    def create_k_fol_data(self, tr_X, tr_y):
        ...
        X1, X2, X3 = hyper_X.iloc[splits[0]:splits[1]], hyper_X.iloc[splits[1]:splits[2]], hyper_X.iloc[splits[2]:splits[3]]
